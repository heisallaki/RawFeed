import { NewsSourceSummary, RawFeedEvent, RawFeedEventDetail } from "./types";
...
export function fetchSources(): Promise<NewsSourceSummary[]> {
  return apiFetch<NewsSourceSummary[]>("/api/sources");
}